...
#> v lintr        1.0.3          v rhub         1.0.2     
#> v goodpractice 1.0.2          v roxygen2     6.1.1     
#> v pkgdown      1.1.0.9000     v sinew        0.3.8     
#> v usethis      1.4.0.9000     v styler       1.0.2.9000
#> -- Conflicts -------------------------------------------------------------------------------------- devtoolverse_conflicts() --
#> x pkgdown::build_site()          masks devtools::build_site()
#> x rhub::check()                  masks devtools::check()
